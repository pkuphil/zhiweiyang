...
<body>
  ...
  <span style="color: #d63384;">philosophy of mind</span> and 
  <span style="color: #20c997;">philosophy of perception</span>.
    ...
    <main class="center">
      ...
      <section id="wip-section">
        ...
        <div data-tag="mind language" class="wip-item">
          <p class="wip-title" onclick="toggleAbstract(this)">▶ Do Semantic Properties Involve the Future?</p>
        ...
        <div data-tag="perception mind" class="wip-item">
          <p class="wip-title" onclick="toggleAbstract(this)">▶ Cross-modal Experiences and the Problem of Phenomenal Overlap</p>
          <div class="wip-abstract" style="display: none;">
            <p style="font-size: 0.9em; color: #666; margin-top: -10px; margin-left: 20px;">
